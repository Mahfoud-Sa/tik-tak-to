...
def About():
    a=msg.showinfo('Hellow','Helloe everyone\n I enterduce this simple X/O Game and hope you engoy this game \n by Mahfoud Mohammed Binsabbah \nDatethe second of may 2020 ')
    b=msg.askyesno('????','Do you like thid game')
    if b ==0:
        while 1:
            pass
...
s1=Label(text='Hellow in our XO Game',font='italian',relief='groove')
